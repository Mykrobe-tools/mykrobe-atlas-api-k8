...
curl -X POST \
    ...
    \"config\": {
        ...
        \"database.history.kafka.bootstrap.servers\" : \"mykrobe-confluent-kafka.$NAMESPACE.svc.cluster.local:9092\"
        }
...
curl -X POST \
    ...
    \"config\": {
        ...
        \"name\": \"core_experiments\",
        \"auto.create\": \"false\",
        \"connection.url\": \"jdbc:mysql://mykrobe-mysql.$NAMESPACE.svc.cluster.local:3306/mykrobe\",
