...
sed -i "s~#{DB_SERVICE_HOST}~$DB_SERVICE_HOST~g" atlas-api-deployment.json
sed -i "s~#{DB_SERVICE_PORT}~$DB_SERVICE_PORT~g" atlas-api-deployment.json
...
sed -i "s~#{KEYCLOAK_ADMIN_PASSWORD}~$KEYCLOAK_ADMIN_PASSWORD~g" atlas-api-deployment.json
